    ...
    <section id="recursos">
      ...
      <div class="resource-layout">
        ...
        <article class="resource-group" id="manuais">
          ...
          <div class="resource-list">
            <a class="resource-link" href="https://github.com/mrcimoveis-coder/portal-intranet/blob/main/Aluguel_Mensal_Guia_Operacional.pdf" target="_blank"><span class="mini-icon">PDF</span><span class="copy"><b>Aluguel Mensal - Guia Operacional <span class="manual-new">NOVO</span></b><small>Cobranças, reajustes, boletos e remessa bancária.</small></span><span class="arrow">›</span></a>
