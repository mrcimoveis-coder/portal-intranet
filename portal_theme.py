    ...
    <section id="recursos">
      ...
      <div class="resource-layout">
        ...
        <article class="resource-group" id="manuais">
          ...
          <div class="resource-list">
            <a class="resource-link" href="https://raw.githubusercontent.com/mrcimoveis-coder/portal-intranet/main/manual_financeiro_mrc.pdf" target="_blank"><span class="mini-icon">PDF</span><span class="copy"><b>Sistema Financeiro MRC <span class="manual-new">NOVO</span></b><small>Saldos, baixas, forecast, cauções e distribuição.</small></span><span class="arrow">›</span></a>
